import 'package:whatsapp/ui/ButtonCard.dart';
import 'package:whatsapp/ui/ContactCard.dart';
import 'package:whatsapp/Model/ChatModel.dart';
import 'package:whatsapp/screen/CreateGroup.dart';
...
class _SelectContactState extends State<SelectContact> {
  ...
  Widget build(BuildContext context) {
    List<ChatModel> contacts = [
      ChatModel(name: "Alvy Fauzi", status: "Available"),
      ChatModel(name: "Loki", status: "Hello"),
      ChatModel(name: "Alex", status: "Cowo selalu setia"),
      ChatModel(name: "Siskaeee", status: "Siska e 3x"),
      ChatModel(name: "Pizza Hut", status: "Ur baby"),
      ChatModel(name: "Kakang", status: "Belajar"),
